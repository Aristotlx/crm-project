...
<script type="text/javascript">
	...
	$(function(){
			...
			$.ajax({
				...
				success:function (data){
					if (data.code=='1'){
						...
						htmlStr+="<img title=\"${sessionScope.sessionUser.name}\" src=\"image/user_icon黑色柳丁.jpg\" style=\"width: 30px; height:30px;\">";
		...
		//给所有市场活动备注后边的修改图标添加“单击”事件
		$("#remarkDivList").on("click","a[name='editA']",function (){
			//获取备注的id和noteContent
			var id = $(this).attr("remarkId");
			var noteContent = $("#div_"+id+" h5").text();
			//把修改的id和noteContent写到修改市场活动备注的模态窗口
			$("#edit-id").val(id);
        ...
        <div class="modal-dialog" role="document" style="width: 40%;">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="updateRemar kBtn">更新</button>
                </div>
            </div>
        </div>
    </div>
...
<%--		遍历remarkList，显示所有备注--%>
		<c:forEach items="${remarkList}" var="remark">
			<div  id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
				<img title="${remark.createBy}" src="image/user_icon黑色柳丁.jpg" style="width: 30px; height:30px;">
