...
<script type="text/javascript">
	...
	$(function(){
		...
		$(".mydate").datetimepicker({
			...
			autoclose:true,//选择完日期事件后，是否自动关闭日历
		...
		$("#tBody").on("click","input[type='checkbox']",function (){
			...
			if ($("#tBody input[type='checkbox']").size()==$("#tBody input[type='checkbox']:checked").size()){
				...
				//如果列表中的所有checkbox至少有一个没选中，则全选按钮取消
		...
		$("#importActivityBtn").click(function (){
			...
			var suffix = activityFileName.substr(activityFileName.lastIndexOf(".")).toLowerCase();
			if (".xls"!=suffix){
				alert("只支持xls文件")
				return;
			}
			...
			$.ajax({
				...
				data:formData,
				processData:false,//设置ajax向后台提交参数之前，是否把参数统一转换成字符串，true--是，false--否
				contentType:false,//设置ajax向后台提交参数之前,是否把所有的参数统一按urlencoded编码，true--是，false--否，默认是true
				type:'post',
				dataType:'json',
				success:function (data){
					if (data.code=="1"){
